...
// $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    vector< Point2f > points1, points2;  // pixel coordinates of matched points
...
// $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    for (int i=0;i<n;i++)
    {
        points1[i].x = points_1[i].y;
        points1[i].y = points_1[i].x;
        points2[i].x = points_2[i].y;
        points2[i].y = points_2[i].x;
    }       

    // circle all good points in first image
//    for (int i=0;i<n;i++)
//        circle(img_matches, points1[i], 10, Scalar(0,255,0), 3);
...
//    waitKey();
    ...
    E = findEssentialMat(points1, points2, camIntrinsic, RANSAC, 0.999, 1.0, mask);
    cout << "Essential Matrix: " << endl << " " << E << endl;

    /* use cheirality check to obtain R, t */
    recoverPose(E, points1, points2, camIntrinsic, R[1], t[1], mask);
...
// $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    /* Triangulation */
    triangulatePoints(listOfproj[0], listOfproj[1], points1, points2, points4D);
